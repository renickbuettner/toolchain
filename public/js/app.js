...
/*!*********************************!*\
  !*** ./resources/js/api/api.js ***!
  \*********************************/
/*! exports provided: ToolchainAPI */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ToolchainAPI", function() { return ToolchainAPI; });
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./service */ "./resources/js/api/service.js");
...
/* harmony import */ var _generals_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./generals/i18n */ "./resources/js/generals/i18n.js");
/**
...
window.tc.i18n = new _generals_i18n__WEBPACK_IMPORTED_MODULE_3__["i18n"]();
...
/* harmony import */ var _wysiwyg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./wysiwyg */ "./resources/js/editor/wysiwyg.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  ...
  _createClass(ServiceEditor, [{
    ...
    key: "_registerWysiwygEditor",
    value: function _registerWysiwygEditor() {
      this._wysiwyg = new _wysiwyg__WEBPACK_IMPORTED_MODULE_1__["WysiwygEditor"](this._description);
    }
    /**
...
/***/ "./resources/js/editor/wysiwyg.js":
/*!****************************************!*\
  !*** ./resources/js/editor/wysiwyg.js ***!
  \****************************************/
/*! exports provided: WysiwygEditor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WysiwygEditor", function() { return WysiwygEditor; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/*#__PURE__*/
function () {
  function WysiwygEditor(parentElement) {
  ...
  _createClass(WysiwygEditor, [{
    ...
    value: function getContent() {
      if (this._parentElement && this._parentElement.type === 'textarea') {
        return $("#".concat(this._parentElement.id)).trumbowyg('html');
      } else {
    ...
    value: function setContent(html) {
      if (this._parentElement && this._parentElement.type === 'textarea') {
        $("#".concat(this._parentElement.id)).trumbowyg('html', html);
      } else {
        throw new Error('Editor parentElement is not initialized');
      }
    }
    ...
    value: function _renderEditor() {
      this._trumbowyg = $("#".concat(this._parentElement.id)).trumbowyg();
    }
  }]);
...
/* harmony import */ var _api_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/service */ "./resources/js/api/service.js");
/* harmony import */ var _dialog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dialog */ "./resources/js/generals/dialog.js");
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./i18n */ "./resources/js/generals/i18n.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
    ...
    value: function _addActionDelete() {
      ...
      btn.onclick = function (event) {
        var confirm = function () {
          _this2._api.removeService(_this2._api.getSlug());

          _this2._dialog.hide();
        }.bind(_this2);

        var params = {
          title: _this2._i18n('actions.delete.item'),
          content: _this2._i18n('actions.delete.info'),
          actions: [{
            title: _this2._i18n('dialog.cancel'),
            attrs: null,
            className: 'btn-default abort'
          }, {
            title: _this2._i18n('dialog.confirm'),
            attrs: [['onclick', confirm]],
            className: 'btn btn-outline-danger confirm'
          }],
          _class: 'confirmation-dialog delete'
        };
        _this2._dialog = new _dialog__WEBPACK_IMPORTED_MODULE_1__["Dialog"](params);
...
/***/ "./resources/js/generals/dialog.js":
/*!*****************************************!*\
  !*** ./resources/js/generals/dialog.js ***!
  \*****************************************/
...
function () {
  ...
  _createClass(Dialog, [{
    key: "show",
    value: function show() {
      var elem = this._renderDialog();

      this._dialog = new bootstrap_js_src_modal__WEBPACK_IMPORTED_MODULE_1__["default"](elem);
    ...
    value: function _renderDialog() {
      ...
      div.className = "modal ".concat(this._class);
      div.tabIndex = -1;
      div.role = 'dialog';
      ...
      header.append(title);
      var dismissIconBtn = document.createElement('button');
      dismissIconBtn.type = 'button';
      dismissIconBtn.className = 'close';

      dismissIconBtn.onclick = function () {
        _this.hide();
      }.bind(this);
      ...
      var dismissIconBtnInner = document.createElement('span');
      ...
      this._actions.forEach(function (action) {
        footer.append(_this._renderAction(action));
      }.bind(this));
    ...
    key: "_renderAction",
    value: function _renderAction(_ref2) {
      var _this2 = this;
      ...
      if (className.match(/(abort)/gi)) {
        ...
        attrs[1] = ['onclick', function (event) {
          _this2.hide();
        }.bind(this)];
      }

      var action = document.createElement('button');
      action.className = "btn ".concat(className);
      action.type = 'button';
...
__webpack_require__(/*! /Users/renickbuettner/Repos/toolchain/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/renickbuettner/Repos/toolchain/resources/sass/app.scss */"./resources/sass/app.scss");
